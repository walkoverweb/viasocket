...
//                             <div key={index} className="border-b-4 border-black-400 border-opacity-100 border-color:black;">
//                                 <li
//                                     className={`cursor-pointer flex items-center px-4 py-6 ${selectedUsecase === index ? 'bg-gray-200' : ''}`}
//                                     onClick={() => handleUsecaseClick(index)}
//                                 >
//                                     {usecase.heading}
//                                     {selectedUsecase === index && (
//                                         <span className="ml-2 w-3 h-3 rounded-full bg-sky-500 "></span>
//                                     )}
//                                 </li>
//                             </div>
//                         ))}
