...
//     return (
//         <div>
//             <div className="flex lg:flex-row flex-col lg:gap-14 gap-5  ">
//                 {pathArray.length < 3 && (
//                     <div className="flex lg:flex-col sm:flex-row gap-4 lg:items-start items-center  ">
...
//                                             const notSameAsSelected = selectedApp !== app?.appslugname;

//                                             if (notSameAsSelected) {
//                                                 return (
//                                                     <a
//                                                         key={app?.rowid}
//                                                         href={
...
//                             >
//                                 {
//                                     isDataLoading ?<div className='skeleton w-[100px] h-[34px]'></div>
//                                  :<div className='flex items-center'> Load More
//                                 <MdKeyboardArrowDown fontSize={22} /></div>
//                                 }
...
const IntegrationSearch = ({
    ...
    handleCategoryClick,
    selectedCategory,
    setSelectedCategory, // Added to update the selected category
    filteredData,
    handleLocalStore,
    visibleItems,
    apps,
    ...
    const handleCategoryItemClick = (category) => {
        setSelectedCategory(category); // Correctly update selected category
        handleCategoryClick(); // Toggle dropdown
    };
                        ...
                        <div className="dropdown dropdown-bottom lg:hidden sm:block w-[100px]">
                            ...
                            {isCategoryDropdownOpen && (
                                <ul
                                    ...
                                    className="dropdown-content z-[1] menu  py-4 shadow bg-white border-[#f5f5f5] rounded-md w-48"
                                >
                                    {uniqueCategories.slice(0, visibleCategories).map(
                                        (
                                            category,
                                            index // Correctly render categories
                                        ) => (
                                            <li
                                                key={index}
