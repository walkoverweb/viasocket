      ...
      <div className="flex w-screen md:h-screen flex-col-reverse md:flex-row">
        <div className="md:w-3/5 w-full p-6 py-12 md:px-10">
          <Image
            ...
            alt="viasocket"
          />
          <div className="my-6 font-bold">Latest updates</div>
          <div className="signup_img my-6 w-full relative">
            ...
            <p className="absolute bottom-6 left-6 font-medium text-black">
              Trusted by 10,000+ startups and enterprises
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row gap-5">
            <div className="w-auto">
              ...
              <p>
                Be the first to know if your domain is added to a DNSBLs such as
                those offered by Spamhaus with removal requests generated by
                Resend.
              </p>
            </div>
            <div className="w-auto">
