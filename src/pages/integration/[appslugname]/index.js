...
const IntegrationSlugPage = ({ combos, apps, pathArray }) => {
                ...
                {cardsData?.length > 0 ? (
                    <div className="container grid  lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-center md:justify-start gap-10 py-10">
                        {cardsData
                            ...
                            .map((card, index) => {
                                const triggerDescription = getEventDescription(
                                    card.trigger.id
                                )
                                const actionDescriptions = card.action.map(
                                    (action) => getEventDescription(action.id)
                                )
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="card rounded-lg bg-white border relative justify-between"
                                    >
   ...
   <p className='text-base'>Details</p>
                    ...
                    //     No matching combination was found. Please try again with
                    //     different parameters or reach out to support for
                    //     assistance.
                    //     <div>
                    //         <button
            ...
            <div className="bg-[#F5F5F5] py-10 hidden">
                ...
                <div className="flex flex-col gap-6 justify-center items-center container">
                    ...
                    <p className="md:text-lg text-base ">
                        Interakt templates to make quick automation, just in few
                        click away to automate your tasks
                    </p>
                </div>
                {/* blogs */}
                ...
                <div className="flex lg:flex-row md:flex-row flex-col gap-10 container justify-between">
                  ...
                  Learn more
                    ...
                    <div className="flex flex-1 flex-col gap-4">
                        ...
                        <p className="md:text-xl text-base ">
                            viasocket is an innovative and versatile workflow
                            automation platform designed to streamline and
                            simplify the integration of your favorite
