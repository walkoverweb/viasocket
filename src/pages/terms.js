                    ...
                    <div align="center" style={{ textAlign: 'left' }}>
                        <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                            ...
                            >
                                ...
                                <bdt className="block-component" /> and <bdt className="question">viaSocket</bdt>
                                <bdt className="block-component" />
                                <bdt className="forloop-component" />
                                <bdt className="statement-end-if-in-editor" />
                                <bdt className="statement-end-if-in-editor" /> (
                                <bdt className="block-component" />'<strong>Company</strong>', '<strong>we</strong>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            at{' '}
                                            <bdt className="question">
                                                Walkover Web Solutions Pvt Ltd, 405-406, CAPTAIN C.S.NAYUDU ARCADE
                                            </bdt>
                                            <bdt className="block-component" />
                                        </span>
                                    </span>
                    ...
                    <div align="center" style={{ textAlign: 'left' }}>
                        ...
                        <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                            ...
                            >
                                ...
                                <bdt className="block-component" />, <bdt className="question">Indore</bdt>
                                <bdt className="block-component" />, <bdt className="question">Madhya Pradesh</bdt>
                                <bdt className="statement-end-if-in-editor" />
                                <bdt className="block-component" /> <bdt className="question">452001</bdt>
                                <bdt className="statement-end-if-in-editor" />
                                <bdt className="block-component">
